package com.victor.teemo.util;

public interface Constantes {
	
	public static final String APP = "Teemo";
	
	// Ancho y alto de la pantalla de juego
	public static final int SCREEN_ANCHO = 800;
	public static final int SCREEN_ALTO = 600;
	public static final float ENEMY_RATE = 1;
	
	public static final int ANCHURA_ENEMIGO = 40;
